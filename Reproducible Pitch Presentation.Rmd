...
The application is running on (https://msa2000.shinyapps.io/ShinyApplication/)

ui.R, and Server.R Code in my github repository (https://github.com/Sarfraz2505/Shiny-Application-and-Reproducible-Pitch.git)
